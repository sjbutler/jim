...
class ASTEnumDeclaration extends SimpleNode {
  ...
  public ASTEnumDeclaration(Java15Parser p, int id) {
    super(p, id);
  }

  public static Node jjtCreate(int id) {
    return new ASTEnumDeclaration(id);
  }

  public static Node jjtCreate(Java15Parser p, int id) {
    return new ASTEnumDeclaration(p, id);
  }
...
/* JavaCC - OriginalChecksum=66bdc99a23d508d17a00a6154750b9de (do not edit this line) */
