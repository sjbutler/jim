/* Java15ParserTokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Java15ParserTokenManager.java */
package uk.ac.open.crc.jim.parser.java15;
import java.io.*;

/** Token Manager. */
@SuppressWarnings("unused")public class Java15ParserTokenManager implements Java15ParserConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public Java15ParserTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public Java15ParserTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
